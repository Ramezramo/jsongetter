...
class CreateFile_10Table extends Migration
{
    public function up()
    {
        Schema::create('file_10', function (Blueprint $table) {
            $table->id();
            $table->integer('id');
            $table->string('name');
            $table->string('slug');
            ...
            $table->string('appointment_duration_unit');
            $table->timestamps();
        });
    }
