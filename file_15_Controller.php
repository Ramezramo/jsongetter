<?php
    ...
    use App\Models\File_15;
    use Illuminate\Http\Request;

    class file_15_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_15::all());
        }
        ...
        return File_15::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_15::find($id));
        }
