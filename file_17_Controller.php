<?php
    ...
    use App\Models\File_17;
    use Illuminate\Http\Request;

    class file_17_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_17::all());
        }
        ...
        return File_17::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_17::find($id));
        }
