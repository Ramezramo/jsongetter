<?php
    ...
    use App\Models\File_21;
    use Illuminate\Http\Request;

    class file_21_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_21::all());
        }
        ...
        return File_21::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_21::find($id));
        }
