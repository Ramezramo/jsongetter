<?php
    ...
    use App\Models\File_11;
    use Illuminate\Http\Request;

    class file_11_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_11::all());
        }
        ...
        return File_11::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_11::find($id));
        }
