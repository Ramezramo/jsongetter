<?php
    ...
    use App\Models\File_16;
    use Illuminate\Http\Request;

    class file_16_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_16::all());
        }
        ...
        return File_16::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_16::find($id));
        }
