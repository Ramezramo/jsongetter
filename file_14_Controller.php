<?php
    ...
    use App\Models\File_14;
    use Illuminate\Http\Request;

    class file_14_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_14::all());
        }
        ...
        return File_14::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_14::find($id));
        }
