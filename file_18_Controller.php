<?php
    ...
    use App\Models\File_18;
    use Illuminate\Http\Request;

    class file_18_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_18::all());
        }
        ...
        return File_18::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_18::find($id));
        }
