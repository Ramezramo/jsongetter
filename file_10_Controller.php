<?php
    ...
    use App\Models\File_10;
    use Illuminate\Http\Request;

    class file_10_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_10::all());
        }
        ...
        public function store(Request $request)
        {
            ...
            'appointment_duration_unit'=>'required'
            ]);
        return File_10::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_10::find($id));
        }
