<?php
    ...
    use App\Models\File_13;
    use Illuminate\Http\Request;

    class file_13_Controller extends Controller
    {
        public function index()
        {
                    return response()->json(File_13::all());
        }
        ...
        return File_13::create($validated);
        }

        public function show($id)
        {
                    return response()->json(File_13::find($id));
        }
